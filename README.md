...
|---|---|
| `adguard` | `show`, `diff`, `pull` |
| `backup` | leaf command |
| `brand` | `build`, `kit`, `status` |
| `cf-dns` | `show`, `diff`, `pull` |
| `decrypt` | leaf command |
| `dns-test` | leaf command |
| `doc-to-pdf` | leaf command |
| `encrypt` | leaf command |
| `hq` | `manifest`, `sync`, `doctor`, `schema`, `validate`, `create`, `deploy`, `ship`, `logs`, `restart`, `open`, `shell`, `superuser`, `export` |
| `inbox` | leaf command |
| `nginx` | `show`, `diff`, `pull` |
| `open-age` | leaf command |
| `remember` | leaf command |
| `site` | `status`, `sync`, `check`, `contrast`, `parity`, `build`, `publish`, `sign-security`, `check-security`, `scaffold-primer`, `scaffold-field`, `draft-alt`, `publish-all`, `publish-writeup`, `validate`, `tech`, `featured`, `manage`, `verify`, `diagnose`, `release`, `test`, `doctor`, `reinstall-mcp`, `new-writeup`, `seo`, `dev`, `open`, `compare`, `og` |
| `tools` | `status`, `doctor`, `check`, `new`, `install`, `key`, `watch`, `describe`, `generate` |
| `ts-acl` | `show`, `diff`, `pull` |
| `vault` | `sync`, `status`, `inbox` |
...
tools generate   # regenerate completions + the README command index
```
...
`docs/describe.schema.json`, checks generated surfaces, and runs the bench
assertions in `bench/`.
